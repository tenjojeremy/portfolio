		...
		return (
			<ParticlesCon>
				...
				<InfoContainer>
					...
					<AboutMe>
						I am a web developer who enjoys the challenges of solving modern problems by using the latest and greatest
						web tools at my disposal. I love Javascript, but I am always experimenting with new technologies that make
						my development more efficient.
					</AboutMe>
